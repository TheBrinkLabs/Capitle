...
// Colors mirror the Aluna house banner's brand (see aluna_house_ad.dart's
// AlunaBanner) — kept as their own copy here rather than shared, since
// this fallback lives on a different ad surface (the "watch an ad for a
// clue" MREC screen) with its own lifecycle and isn't meant to couple to
// the banner file.
...
/// the real network ads fail to fill — a bigger, 300x250 sibling of the
